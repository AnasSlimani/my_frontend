    ...
    try {
        ...
        const response1 = await fetch(`http://localhost:8082/api/reservation/reservecar/${reservationId}/${startDate}/${endDate}`, {
            ...
            headers: {
                ...
                "Authorization": `Bearer ${token}`, // Fix: Template literal syntax corrected
            },
        });
        ...
        if (response1.ok) {
            ...
            console.log("Failed to reserve the car: " + response1.statusText);
        }
    } catch (error) {
        console.log("Error while reserving car: " + error);
    }
};
